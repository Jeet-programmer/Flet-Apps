  ...
  circle = Stack(
    controls=[
      ...
      Container(
                ...
                foreground_image_url="https://img.freepik.com/premium-vector/man-avatar-profile-round-icon_24640-14044.jpg?w=2000"
            )
                          )
                          )
                      ],
  ...
  for i in range(2):
    tasks.controls.append(
      ...
      content=CustomCheckBox(
        color=PINK,
        label='Adding functionality to button'
      )),
